		...
		return {
			...
			producers: [
				...
				},
				{
					...
					text:
						"Éleveurs de lapins depuis 1992,c‘est en 2011 que Jean-Pierre et Sylvie Duval ont décidé de se consacrer à la transformation et la vente directe. Les 90 mères donnent naissances à des lapereaux qu’ils engraissent sur une période de 13 à 19 semaines avec un aliment lapin (A base de luzerne, betterave, céréales, vitamines et minéraux) sans antibio-tique ni OGM. Si besoin les lapins sont soignés avec des huiles es-sentielles (Cannelle , Eucalyptus , Giroflier , Lemon grass , Origan).",
					array: "becassiere",
				},
				{
					name: "La Clémencière",
				...
				},
				{
					...
					city: "72 La Lude",
					text:
						"Ferme familiale depuis 5 générations, située au Lude sur le bord du Loir, il y est produit du fromages et des laitages au lait cru de vache. Multiples saveurs grâce aux prairies permanentes à la flore très variée des zones humides. Ketty, Cécile, Joël et Lucie ont le plaisir de produire en agriculture bio-logique avec un troupeau de 30 vaches de races mixtes.",
					array: "frene_fromage",
				},
				{
				...
				},
				{
					...
					city: "49 Jarzé",
					text:
						"La ferme Bio du Point du Jour vous propose une gamme de pâtes se-mi-complète fabriquées à la ferme avec leur propre céréales. Les cé-réales sont cultivées en agriculture biologiques, récoltés, stockés et transformés chez eux dans leur atelier.",
					array: "jarze",
				},
				{
				...
				},
				{
					...
					text:
						"Jeune agriculteur installé depuis 2017 agriculture biologique, Benoît cultive du colza et tournesol. Les graines qu’il récolte sont sé-chées, triées, pressées, filtrées afin d'extraire l'huile. La mise en bouteille est également effectuée par ses soins. Tout est réalisé sur l'exploitation d'où le nom 'de la graine à l'huile'",
					array: "huile",
				},
				{
					...
					text:
						"Apicultrice professionnelle installée sur Baugé en Anjou. Anne vous propose une gamme de miels provenant que du territoire du Baugeois(20kms autour de baugé). Son choix est de respecter ses abeilles et leur environnement. Elle essaie d'appliquer ce slogan 'BON- PROPRE-JUSTE'.<br/>* La Miellée Gourmande : Mélangeant de façon harmonieuse le goût légèrement confit de l’oignon et la délicatesse des fleurs de forêt, cette miellée saura satisfaire aussi bien les gourmands que les cordons bleus.br/>* La Miellée du Baugeois : Cette Miellée, avec ses saveurs de châtaigniers, saura vous emmener en balade dans le Baugeois. Nous la récoltons courant juillet, elle vous offre une palette riche de marrons mais la couleur ambre est souvent prépondé-rante.<br/>* La Miellée de la Forêt : La particularité de cette miellée réside dans son mélange de nectars et de miellats variés. La difficulté de cette miellée vient du fait qu’elle s’opère à n’importe quel moment de l’été. Il faut donc, en fonction des ruchers, surveil-ler ce que peuvent rentrer les abeilles.<br/> La Miellée du Soleil : Vous trouverez dans la miellée du printemps un mélange de fleurs en fonc-tion des différents ruchers : les pommiers en fleurs, les cerisiers, les cassis, les trèfles, les pissenlits et le colza.<br/>* La Miellée des Saveurs : Cette miellée est la dernière de la saison apicole. Les abeilles vont sur l’ensemble des fleurs d’été chercher leurs nectars pour en faire ce miel subtil qui saura éveiller vos papilles. Son goût, légèrement fruité, avec différentes saveurs, devrait agrémenter avec douceur vos tartines, tisanes et thés.",
					array: "ruche",
				},
				{
				...
				},
				{
					...
					text:
						"Patrice a découvert le métier de viticulteur dès sa plus tendre enfance grâce à ses parents, des personnes passionnées par leur profession. Il est très vite tombé amoureux de la vigne et du vin. Et depuis, grâce aux conseils avisés de ses parents, il est devenu à son tour viticulteur. Son domaine familial depuis trois générations se situe au coeur de l’appellation Saint-Nicolas-de-Bourgueil. Il s’étend sur 18 hectares, 16 hec-tares en Saint-Nicolas-de-Bourgueil et 2 hectares en Bourgueil. Il produit essentiellement du vin rouge, des cuvées « Tradition », « Vieilles Vignes » et «en fût de chêne ». Ses vins sont légers, souples et frui-tés de cépage 100% cabernet franc. Ils se marient très bien avec tous les mets. Depuis 2020, son exploitation est devenue HVE* (Haute Valeur Environnementale).",
					array: "vignoble",
				},
				{
					name: "GAEC de Bré",
					...
					text:
						"Sébastien et Mélanie HUET, nous propose un produit riche en qualité, La Spiruline. Cette micro algue est produite chez eux dans 200m² de bassin chauf-fés grâce à leur élevage de vaches laitières et leur méthaniseur.La spiruline est récolté, selon la météo, tous les jours ou tous les deux jours. C’est un complément alimentaire très riche. Effectivement, elle est composée à 70% de protéines. Elle pèse également son pesant de fer : 10gr soit 25% des besoins journaliers dans cet élément essentiel.Conditionné en sachet hermétique et à l’abris de la lumière, la spiruline se conserve des années.",
					array: "bre",
				},
				{
